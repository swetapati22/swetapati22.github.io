...
#### ACE05 (machine-generated guidelines, _no negative sampling_)

    - Trigger Classification (TC): +10% improvement
    - Argument Classification (AC): +5% improvement

#### RichERE (machine-generated guidelines, _with negative sampling_)
...
_For collaboration or inquiries, feel free to reach out via [LinkedIn](https://www.linkedin.com/in/sweta-pati/) or [Email](mailto:spati2203@gmail.com)._
